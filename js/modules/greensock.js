...
export function projects() {
  (function () {
    ...
    gsap.set('.projects-media, .project-img, .project-img2, .portfolio-image, .project', { opacity: 0 });
    ...
    fadeInFrom('right', '.portfolio-image');
    fadeInFrom('right', '.project');
    fadeInFrom('right', '.projects-media');
  })();
